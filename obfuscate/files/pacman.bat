...
ECHO %ESC%[?25l%col:c=229;235;52%%ESC%[8;11HDIFFICULTY%ESC%[10;11H[A] EASY%ESC%[12;11H[B] NORMAL%ESC%[14;11H[C] DIFFICULT
(CHOICE /C ABC /N)>NUL
IF %errorlevel% EQU 1 (
    SET "speed=55"
...
ECHO %ESC%[25;6H[A] Try Again%ESC%[26;6H[B] Exit
(CHOICE /C AB /N)>NUL
IF %errorlevel% EQU 1 (
    ENDLOCAL
    GOTO :MENU
