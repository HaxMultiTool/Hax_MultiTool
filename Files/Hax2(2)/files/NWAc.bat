...
pause
cls
echo Activating your Windows...&cscript //nologo slmgr.vbs /ckms >nul&cscript //nologo slmgr.vbs /upk >nul&cscript //nologo slmgr.vbs /cpky >nul&set i=1&wmic os | findstr /I "enterprise" >nul
...
if %errorlevel% EQU 0 (cscript //nologo slmgr.vbs /ipk W269N-WFGWX-YVC9B-4J6C9-T83GX >nul||cscript //nologo slmgr.vbs /ipk MH37W-N47XK-V7XM9-C7227-GCQG9 >nul||cscript //nologo slmgr.vbs /ipk NRG8B-VKK3Q-CXVCJ-9G2XF-6Q84J >nul||cscript //nologo slmgr.vbs /ipk 9FNHH-K3HBT-3W4TD-6383H-6XYWF >nul||cscript //nologo slmgr.vbs /ipk 6TP4R-GNPTD-KYYHQ-7B7DP-J447Y >nul||cscript //nologo slmgr.vbs /ipk YVWGF-BXNMC-HTQYQ-CPQ99-66QFC >nul&goto servers) else (goto nonsupportato)
:servers
if %i% GTR 10 goto occ
if %i% EQU 1 set KMS=kms7.MSGuides.com
if %i% EQU 2 set KMS=s8.uk.to
if %i% EQU 3 set KMS=s9.us.to
if %i% GTR 3 goto confir
cscript //nologo slmgr.vbs /skms %KMS%:1688 >nul
:confir
echo.
echo.
cscript //nologo slmgr.vbs /ato | find /i "Attivato!" && (echo.&echo ============================================================================&echo.&echo Molto semplice, vero?&echo.&echo Windows Activator Tool&echo By Chroma Toggled, Thanks to MSGuides.com&echo.&echo =================================================================&choice /n /c YN /m "premi N per uscire dal programma" & if errorlevel 2 exit) || (echo Ci sto lavorando... & echo. & echo. & set /a i+=1 & goto servers)
explorer "http://MSGuides.com"&goto halt
:notsupported
echo ============================================================================&echo.&echo Ci scusiamo, la tua versione non è supportata.&echo.&goto halt2
:occ
cls
