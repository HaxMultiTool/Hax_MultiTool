...
echo ============================
echo Professional activator for
echo Windows 10, compatible with
echo more recent versions.
echo.
echo.
...
:ato
cscript //nologo slmgr.vbs /ato | find /i "successfully" && (echo.&echo.&echo Microsoft Windows Activator Tool 2&echo.&echo By Chroma&echo.&echo.&echo.&echo ========================================================&choice /n /c YN /m "Press N to exit the program" & if errorlevel 2 exit) || (echo Activating Windows&echo Please wait... & echo. & echo. & set /a i+=1 & goto skms)
goto halt
:notsupported
echo ========================================================&echo.&echo Sorry, your version is not supported.&echo.&goto halt
:busy
echo ========================================================&echo.&echo Servers are busy, please contact support.&echo.
:halt
pause >nul